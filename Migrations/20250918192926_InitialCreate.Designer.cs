...
namespace tracking_code_api.Migrations
{
    ...
    [Migration("20250918192926_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tracking_code_api.AuditoriaMovimentacao", b =>
                {
            ...
            modelBuilder.Entity("tracking_code_api.Localizacao", b =>
                {
            ...
            modelBuilder.Entity("tracking_code_api.Moto", b =>
                {
            ...
            modelBuilder.Entity("tracking_code_api.Setor", b =>
                {
                    b.Property<int>("IdSetor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("tracking_code_api.Tag", b =>
                {
                    b.Property<string>("CodigoTag")
                        .HasColumnType("NVARCHAR2(450)")
                        .HasColumnName("codigo_tag");
            ...
            modelBuilder.Entity("tracking_code_api.Usuario", b =>
                {
                    b.Property<int>("IdFuncionario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("tracking_code_api.AuditoriaMovimentacao", b =>
                {
                    b.HasOne("tracking_code_api.Usuario", "Usuario")
                        .WithMany("Auditorias")
            ...
            modelBuilder.Entity("tracking_code_api.Localizacao", b =>
                {
                    b.HasOne("tracking_code_api.Tag", "Tag")
                        .WithMany("Localizacoes")
                        .HasForeignKey("CodigoTag")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("tracking_code_api.Setor", "Setor")
                        .WithMany("Localizacoes")
            ...
            modelBuilder.Entity("tracking_code_api.Moto", b =>
                {
                    b.HasOne("tracking_code_api.Tag", "Tag")
                        .WithOne("Moto")
                        .HasForeignKey("tracking_code_api.Moto", "CodigoTag")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("tracking_code_api.AuditoriaMovimentacao", "Auditoria")
                        .WithMany()
